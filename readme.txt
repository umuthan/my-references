...
A Wordpress plugin to list your references with shortcode or widget.
...
1. Upload the plugin files to the `/wp-content/plugins/my-references` directory, or install the plugin through the WordPress plugins screen directly.
